...
export const INBOUND_DISPOSITION: Record<WebviewMsg["type"], InboundDisposition> = {
  ...
  listCustomModels: "host-local",
  addModelSubmit: "host-local",
  saveConfigFile: "host-local",
...
export const OUTBOUND_DISPOSITION: Record<HostMsg["type"], OutboundDisposition> = {
  ...
  customModels: "host-local",
  configOpened: "host-local",
  addModelResult: "host-local",
  configSaved: "host-local",
  initialized: "mirror",
  cliUpdating: "mirror",
  session: "mirror",
