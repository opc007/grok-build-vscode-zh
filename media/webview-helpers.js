(function (root) {
  ...
  const HOST_MESSAGE_TYPES = [
    "initialState", "moveViewHint", "providerState", "codexInstallProgress", "planModeAvailability", "showThinking", "appPurpose", "fontScale", "grokUpdateStatus", "updateAvailable", "updateReady", "telemetryEnabled", "customModels", "configOpened", "addModelResult", "configSaved", "initialized",
  ...
  const WEBVIEW_MESSAGE_TYPES = [
    ...
    "openGlobalConfig", "openProjectConfig", "listCustomModels", "addModelSubmit", "saveConfigFile", "runMcpList", "showLogs", "toggleDevTools", "openSettings", "openSettingsSurface", "closeSettingsSurface", "moveView",
    ...
    "openUpdateRelease", "restartToUpdate", "downloadUpdate", "startComputerUse", "stopComputerUse", "setLanguage",
  ];
